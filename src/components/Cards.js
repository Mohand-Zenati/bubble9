...
function Cards() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      const response1 = await fetch('http://bubble9.zenati.butmmi.o2switch.site/api/visite_total.php');
      ...
      const response3 = await fetch('http://bubble9.zenati.butmmi.o2switch.site/api/total.php');
